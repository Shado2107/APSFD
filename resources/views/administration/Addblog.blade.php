          ...
          <div class="col-md-10 col-md-offset-1">
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Aticles publiés sur le blog</h3>
                    ...
                    <td style="width:40px">
                        <a >
                            <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal-default" data-target="Modifier" data-placement="top">
                             ...
                             <button id=" {{$act->id}} " class="btn btn-danger btn-xs delbtn" data-toggle="modal" data-target="Modifier" data-placement="top">
    ...
    $(document).on('click','.btnedit',function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                updateform.find('#libellecat').val(response.libellecat);
